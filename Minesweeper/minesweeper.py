...
window.iconbitmap("C:/Minesweeper/mine1.ico")
...
def SetMines():
    global Mines
    f=open("C:/Minesweeper/Fieldnumber.txt","r")
    r=f.readline(1)
    f.close()
    f=open("C:/Minesweeper/Minecord.txt","r")
    j=1
    while j<=int(r):
        Field=f.readline()
        j=j+1
    ...
    if int(r)!=5:
        ...
        r=1
    f=open("C:/Minesweeper/Fieldnumber.txt","w")
    f.write(str(r))
    f.close()
def Minefield():
    SetMines()
...
GoBack=ImageTk.PhotoImage((Image.open("C:/Minesweeper/backicon.jpg")).resize((47,47)))
Reset=ImageTk.PhotoImage((Image.open("C:/Minesweeper/reseticon.jpg")).resize((47,47)))
Mine=ImageTk.PhotoImage((Image.open("C:/Minesweeper/mine.jpg")).resize((47,47)))
...
def Window2():
    ...
    lose.iconbitmap("C:/Minesweeper/mine1.ico")
    lose.resizable(0,0)
...
def Win():
    ...
    win.iconbitmap("C:/Minesweeper/mine1.ico")
    win.resizable(0,0)
